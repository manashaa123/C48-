class Game{
    ...
    play(){
                ...
                this.submit.mousePressed(()=> {
                 if (system.authenticate(actualWord, this.input1.value())) {
                    Letters2 = createSprite(500, 100);
                    Letters2.addImage("Letters2", Letters2_img);
                 }
                });

                authenticate(actualWord, enteredWord) {
                    if (actualWord === enteredWord) {
                   text("That's Right!", 500, 100);
                    }
                   else {
